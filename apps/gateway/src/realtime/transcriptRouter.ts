...
function buildSystemPrompt(): string {
  return [
    ...
    "If the transcript contains a DIRECT request to the agent (e.g. 'hey agent...', 'agent, look up...', 'agent, what is...'), do NOT create a topic or node for it — those quick questions are answered separately. Only create map topics for the substantive discussion itself.",
